...
<style>
	* {
	...
	.div-close-user-pwck-input {
		height : 18rem;
	}
	
	.btn-close-pwck-submit {
		border : 1px solid #76BEFF;
		border-radius : 5px;
		...
		<div class = "col-4 offset-4 px-5">
			...
			<div class = "row mb-2 div-close-user-pwck-input">	
				<form action = "close_pwck" method = "post" class = "col-10 offset-1">
					<div class = "row my-4">
						<input name = "userPw" type = "password" class = "w-100 p-2" placeholder = "비밀번호 확인">
					</div>
					<div class = "row my-4">
				...
				<div class = "row my-2 d-flex flex-column justify-content-center align-items-center">
					<div class = "col d-flex justify-content-center align-items-center">					
