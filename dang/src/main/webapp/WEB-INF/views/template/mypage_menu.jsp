		...
		<div class = "offset-2 col-8">
			<div class = "row">
				...
				<div class = "col-2">
					<div class = "row">
						<div class = "col-10 offset-1">			
							<div class = "offset-2 col-8 d-flex justify-content-center align-items-center div-icon-mypage" onclick = "location.href='${pageContext.request.contextPath}/user/edit_user_info_pwck'">
				...
				<div class = "col-2">
					<div class = "row">
						<div class = "col-10 offset-1">			
							<div class = "offset-2 col-8 d-flex justify-content-center align-items-center div-icon-mypage" onclick = "location.href='${pageContext.request.contextPath}/user/change_pw_pwck'">
