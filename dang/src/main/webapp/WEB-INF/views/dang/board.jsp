						...
						<div class="board-box shadow-sm">
							<div class="first-line d-flex">
								...
								<div class="col-7 middle-items ms-3">
									<span class="nick-font">닉네임</span>
								</div>
								<div class="col-4 justify-content-end middle-items">
									<span class="date-font me-4">2023.01.10 오후 3:34</span>
									<i class="fa-solid fa-ellipsis-vertical me-3"></i>
								</div>
							</div>
							
							<div class="second-line text-start ms-2 me-2 mt-3 mb-4" style="height:72px;">
								<span class="content-font">지금은 오후 3시 48분 오늘은 몇시까지 할까요?<br>야호<br>야호</span>
							</div>
							<hr>
							...
							<div class="third-line d-flex ms-3 me-3">
								<div class="col-2 middle-items">
									...
									<span class="blue" style="font-weight:bolder;">3</span>
								</div>
								<div class="col-3 middle-items">
									...
									<span class="blue" style="font-weight:bolder;">7</span>
								</div>
